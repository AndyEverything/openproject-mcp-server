...
class OpenProjectSetup:
    ...
    def create_test_work_package(self, project_id: int, type_id: int) -> Dict:
        ...
        form_response = requests.post(f"{self.base_url}/api/v3/work_packages/form", 
                                    headers=self.headers, json=form_data)
        ...
        response = requests.post(f"{self.base_url}/api/v3/work_packages", 
